...
<div id="content">
    ...
    <div class="quick-actions_homepage">
        <ul class="quick-actions">
            <li><a href="index.jsp"> <i class="icon-dashboard"></i> 协会管理 </a></li>
            ...
            <li><a href="school_manager.jsp"> <i class="icon-calendar"></i> 学校管理 </a></li>
        </ul>
    </div>
    <div id="content_1">
                ...
                <div class="span12">
                    <div class="widget-box">
                        <div class="widget-title">
                            ...
                            <h5>协会简介 <code><a href="association_edit.jsp">点击修改</a></code></h5>
                        </div>
                ...
                <div class="span6">
                    <div class="widget-box">
                        <div class="widget-title">
                            ...
                            <h5>协会性质 <code><a href="association_edit.jsp">点击修改</a></code></h5>
                        </div>
                        <div class="widget-content">
                ...
                <div class="span6">
                    <div class="widget-box">
                        <div class="widget-title">
                            ...
                            <h5>协会宗旨<code><a href="association_edit.jsp">点击修改</a></code></h5>
                        </div>
                        <div class="widget-content">
