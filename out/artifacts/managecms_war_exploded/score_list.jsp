...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"><a href="index.jsp" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a>
            <a
                    href="score_list.jsp" class="current">成绩查看</a></div>
                    ...
                    <div class="widget-content nopadding">
                        <form action="#" method="get" class="form-horizontal">
                            ...
                            <div class="form-actions">
                                <div style="display: inline-block;margin-left: 70%"><a href="competition_manager.jsp" type="submit"
                                                                      class="btn btn-success"
                                                                      style="width: 150px;">查询</a></div>
                                <div style="display: inline-block">
                                    <a href="competition_manager.jsp" type="submit" class="btn btn-success"
                                       style="width: 150px;margin-left: 50px;">导出</a>
                                </div>
                            </div>
                        </form>
                    </div>
